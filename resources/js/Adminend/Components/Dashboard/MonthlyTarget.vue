...
import { DropdownMenu } from '@/Adminend/Components'
import { useMonthlyTarget } from '@/Adminend/Composables'
...
const { menuItems, chartOptions } = useMonthlyTarget()
</script>
    ...
    <div class="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]" >
        <div class="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6" >
            ...
            <div class="relative max-h-[195px]">
                ...
                <span class="absolute left-1/2 top-[85%] -translate-x-1/2 -translate-y-0 rounded-full bg-green-50 px-3 py-1 text-xs font-semibold text-green-600 dark:bg-green-500/15 dark:text-green-500" >
                    +10%
                </span>
            </div>
